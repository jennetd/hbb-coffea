...
# Do initial fit                                                                                                                        
combineTool.py -M MultiDimFit --algo singles -d $modelfile -m 125 --robustFit 1 --cminDefaultMinimizerStrategy 0 --setParameters rZbb1=1,rZbb2=1,rZbb3=1,rZbb4=1,rZbb5=1,rZbb6=1,rZbb7=1,rZbb8=1
