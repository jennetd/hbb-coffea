...
//=========  (Fri Oct 13 16:03:50 2023) by ROOT version 6.12/07
   TCanvas *stxs = new TCanvas("stxs", "stxs",64,1103,800,600);
   gStyle->SetOptStat(0);
...
// ------------>Primitives in pad: pad1
   ...
   pad1->Draw();
   pad1->cd();
   pad1->Range(-1.029412,-0.154947,2.5,4.353983);
   pad1->SetFillColor(0);
   ...
   dummy1__1->SetMinimum(0.7);
   dummy1__1->SetMaximum(8000);
   dummy1__1->SetEntries(3);
   dummy1__1->SetStats(0);
   dummy1__1->SetLineColor(0);
   dummy1__1->SetLineWidth(3);
   dummy1__1->GetXaxis()->SetTitle("ggF p_{T}^{H} [GeV]");
   ...
   dummy1__1->GetXaxis()->SetLabelSize(0.035);
   dummy1__1->GetXaxis()->SetTitleSize(0.035);
   ...
   dummy1__1->GetYaxis()->SetLabelSize(0.04645761);
   dummy1__1->GetYaxis()->SetTitleSize(0.04645761);
   ...
   TH1F *Graph_Graph3003 = new TH1F("Graph_Graph3003","Graph",100,-0.8,2.8);
   Graph_Graph3003->SetMinimum(0.9202118);
   Graph_Graph3003->SetMaximum(920.2118);
   ...
   grae->Draw("p");
   TLatex *   tex = new TLatex(0.19,0.82,"CMS");
tex->SetNDC();
   tex->SetTextSize(0.04645761);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.19,0.76,"H(bb) STXS stage 1.2");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04645761);
   tex->SetLineWidth(2);
...
// ------------>Primitives in pad: pad2
   ...
   pad2->Draw();
   pad2->cd();
   pad2->Range(-1.029412,-14.00013,2.5,16.0003);
   pad2->SetFillColor(0);
   ...
   dummy3__2->GetXaxis()->SetTitle("ggF p_{T}^{H} [GeV]");
   ...
   dummy3__2->GetXaxis()->SetLabelSize(0.09059233);
   dummy3__2->GetXaxis()->SetTitleSize(0.06968641);
   ...
   dummy3__2->GetYaxis()->SetLabelSize(0.06968641);
   dummy3__2->GetYaxis()->SetTitleSize(0.06968641);
   ...
   TH1F *Graph_Graph3006 = new TH1F("Graph_Graph3006","Graph",100,-0.8,2.8);
   Graph_Graph3006->SetMinimum(-5.26);
   Graph_Graph3006->SetMaximum(10.82);
...
// ------------>Primitives in pad: pad3
   ...
   pad3->Draw();
   pad3->cd();
   pad3->Range(2.5,-0.154947,4.852941,4.353983);
   pad3->SetFillColor(0);
   ...
   dummy2__3->GetXaxis()->SetLabelSize(0.035);
   dummy2__3->GetXaxis()->SetTitleSize(0.035);
   dummy2__3->GetXaxis()->SetTitleOffset(1.5);
   dummy2__3->GetXaxis()->SetTitleFont(42);
   dummy2__3->GetYaxis()->SetLabelFont(42);
   dummy2__3->GetYaxis()->SetLabelSize(0.035);
   dummy2__3->GetYaxis()->SetTitleSize(0.035);
   ...
   TH1F *Graph_Graph3009 = new TH1F("Graph_Graph3009","Graph",100,2.3,4.7);
   Graph_Graph3009->SetMinimum(9.566739);
   Graph_Graph3009->SetMaximum(494.6385);
   ...
   grae->Draw("p");
      tex = new TLatex(0.53,0.92,"138 fb^{-1} (13 TeV)");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04645761);
   tex->SetLineWidth(2);
   ...
   TLegend *leg = new TLegend(0.2,0.67,0.9,0.87,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextSize(0.04645761);
   leg->SetLineColor(0);
   leg->SetLineStyle(0);
   leg->SetLineWidth(0);
   leg->SetFillColor(0);
   leg->SetFillStyle(0);
   TLegendEntry *entry=leg->AddEntry("Graph1","Observed (stat #oplus syst)","p");
   ...
   entry=leg->AddEntry("Graph0","ggF (HJ-MINLO)","f");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("Graph0","VBF (POWHEG + HC)","f");
...
// ------------>Primitives in pad: pad4
   ...
   pad4->Draw();
   pad4->cd();
   pad4->Range(2.5,-14.00013,4.852941,16.0003);
   pad4->SetFillColor(0);
   ...
   dummy4__4->GetXaxis()->SetTitle("VBF m_{jj}^{gen} [GeV]");
   ...
   dummy4__4->GetXaxis()->SetLabelSize(0.09059233);
   dummy4__4->GetXaxis()->SetTitleSize(0.06968641);
   dummy4__4->GetXaxis()->SetTitleOffset(1.5);
   dummy4__4->GetXaxis()->SetTitleFont(42);
   dummy4__4->GetYaxis()->SetLabelFont(42);
   dummy4__4->GetYaxis()->SetLabelSize(0.035);
   dummy4__4->GetYaxis()->SetTitleSize(0.035);
   ...
   TH1F *Graph_Graph3012 = new TH1F("Graph_Graph3012","Graph",100,2.3,4.7);
   Graph_Graph3012->SetMinimum(1.1052);
   Graph_Graph3012->SetMaximum(16.1627);
