...
if [ $1 -eq 965 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin3ggfpass2016APV_VBF_s1_mcstat --algo impact --redefineSignalPOIs rVBF1000to1500,rggF300to450,rggF450to650,rggF650plus,rVBF1500plus -P ptbin3ggfpass2016APV_VBF_s1_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root
fi
if [ $1 -eq 966 ]; then
...
if [ $1 -eq 1303 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_dataResidual_2016APVggf_pt_par1_rho_par0 --algo impact --redefineSignalPOIs rVBF1000to1500,rggF300to450,rggF450to650,rggF650plus,rVBF1500plus -P tf_dataResidual_2016APVggf_pt_par1_rho_par0 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root
fi
if [ $1 -eq 1304 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_dataResidual_2016APVggf_pt_par1_rho_par1 --algo impact --redefineSignalPOIs rVBF1000to1500,rggF300to450,rggF450to650,rggF650plus,rVBF1500plus -P tf_dataResidual_2016APVggf_pt_par1_rho_par1 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root
fi
if [ $1 -eq 1305 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_dataResidual_2016APVggf_pt_par1_rho_par2 --algo impact --redefineSignalPOIs rVBF1000to1500,rggF300to450,rggF450to650,rggF650plus,rVBF1500plus -P tf_dataResidual_2016APVggf_pt_par1_rho_par2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root
fi
if [ $1 -eq 1306 ]; then
...
if [ $1 -eq 1322 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_dataResidual_2018ggf_pt_par1_rho_par0 --algo impact --redefineSignalPOIs rVBF1000to1500,rggF300to450,rggF450to650,rggF650plus,rVBF1500plus -P tf_dataResidual_2018ggf_pt_par1_rho_par0 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root
fi
if [ $1 -eq 1323 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_dataResidual_2018ggf_pt_par1_rho_par1 --algo impact --redefineSignalPOIs rVBF1000to1500,rggF300to450,rggF450to650,rggF650plus,rVBF1500plus -P tf_dataResidual_2018ggf_pt_par1_rho_par1 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root
fi
if [ $1 -eq 1324 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_dataResidual_2018ggf_pt_par1_rho_par2 --algo impact --redefineSignalPOIs rVBF1000to1500,rggF300to450,rggF450to650,rggF650plus,rVBF1500plus -P tf_dataResidual_2018ggf_pt_par1_rho_par2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root
fi
if [ $1 -eq 1325 ]; then
