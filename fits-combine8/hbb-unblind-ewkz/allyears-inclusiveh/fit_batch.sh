...
# Do initial fit                                                                                          
combine -M MultiDimFit --algo singles -d $modelfile -m 125 --setParameters rHbb --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 --verbose 9 --saveWorkspace
