...
if [ $1 -eq 114 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbfhipass2016APV_VV_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbfhipass2016APV_VV_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel_2016APV/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 115 ]; then
...
if [ $1 -eq 142 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbflopass2016APV_VV_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbflopass2016APV_VV_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel_2016APV/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 143 ]; then
...
if [ $1 -eq 294 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_MCtempl_ggf2016APV_deco2 --algo impact --redefineSignalPOIs rVBF,rggF -P tf_MCtempl_ggf2016APV_deco2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel_2016APV/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 295 ]; then
