...
if [ $1 -eq 187 ]; then
  combine -M MultiDimFit -n _paramFit_Test_muonCRpass2018_Wjets_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P muonCRpass2018_Wjets_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 188 ]; then
...
if [ $1 -eq 294 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0ggfpass2018_EWKZ_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0ggfpass2018_EWKZ_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 295 ]; then
...
if [ $1 -eq 367 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbfhipass2016APV_VV_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbfhipass2016APV_VV_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 368 ]; then
...
if [ $1 -eq 402 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbfhipass2017_singlet_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbfhipass2017_singlet_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 403 ]; then
...
if [ $1 -eq 416 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbfhipass2018_singlet_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbfhipass2018_singlet_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 417 ]; then
...
if [ $1 -eq 463 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbflofail2018_EWKZbb_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbflofail2018_EWKZbb_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 464 ]; then
...
if [ $1 -eq 479 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbflopass2016APV_VV_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbflopass2016APV_VV_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 480 ]; then
...
if [ $1 -eq 513 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbflopass2017_singlet_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbflopass2017_singlet_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 514 ]; then
...
if [ $1 -eq 517 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbflopass2018_EWKZ_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbflopass2018_EWKZ_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 518 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin0vbflopass2018_EWKZbb_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin0vbflopass2018_EWKZbb_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 519 ]; then
...
if [ $1 -eq 629 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin1ggfpass2018_EWKZ_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin1ggfpass2018_EWKZ_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 630 ]; then
...
if [ $1 -eq 853 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin3ggfpass2018_EWKZ_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin3ggfpass2018_EWKZ_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 854 ]; then
...
if [ $1 -eq 965 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin4ggfpass2018_EWKZ_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin4ggfpass2018_EWKZ_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 966 ]; then
...
if [ $1 -eq 1022 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin5ggffail2018_EWKZbb_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin5ggffail2018_EWKZbb_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 1023 ]; then
...
if [ $1 -eq 1077 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin5ggfpass2018_EWKZ_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin5ggfpass2018_EWKZ_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 1078 ]; then
  combine -M MultiDimFit -n _paramFit_Test_ptbin5ggfpass2018_EWKZbb_mcstat --algo impact --redefineSignalPOIs rVBF,rggF -P ptbin5ggfpass2018_EWKZbb_mcstat --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 1079 ]; then
...
if [ $1 -eq 1092 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_MCtempl_ggf2016APV_deco2 --algo impact --redefineSignalPOIs rVBF,rggF -P tf_MCtempl_ggf2016APV_deco2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 1093 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_MCtempl_ggf2016APV_deco3 --algo impact --redefineSignalPOIs rVBF,rggF -P tf_MCtempl_ggf2016APV_deco3 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 1094 ]; then
...
if [ $1 -eq 1097 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_MCtempl_ggf2017_deco1 --algo impact --redefineSignalPOIs rVBF,rggF -P tf_MCtempl_ggf2017_deco1 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 1098 ]; then
...
if [ $1 -eq 1115 ]; then
  combine -M MultiDimFit -n _paramFit_Test_tf_dataResidual_2016ggf_pt_par0_rho_par2 --algo impact --redefineSignalPOIs rVBF,rggF -P tf_dataResidual_2016ggf_pt_par0_rho_par2 --floatOtherPOIs 1 --saveInactivePOI 1 --robustFit=1 --robustHesse=1 --cminDefaultMinimizerStrategy=0 -m 125 -d output/testModel/model_combined.root --setParameters rVBF=1,rggF=1
fi
if [ $1 -eq 1116 ]; then
