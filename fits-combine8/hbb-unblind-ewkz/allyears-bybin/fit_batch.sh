...
# Do initial fit                                                                                                                        
combineTool.py -M MultiDimFit --algo singles -d $modelfile -m 125 --robustFit 1 --cminDefaultMinimizerStrategy 0 --setParameters rVBF1=4.9,rVBF7=1,rVBF8=1,rggF1=1,rggF2=1,rggF3=1,rggF4=1,rggF5=1,rggF6=1,rggF7=1.6 --freezeParameters rVBF1,rggF7 --saveWorkspace
